...

{
    ...
    echo "      --N_iters 10001 \\"
    echo "      --i_testset 1000 \\"
    echo "      --expname ${dataset}_2_bash_RTXA6000_screen_weight_gt_156 \\"
    echo "      --train_scene ${train_scene}\\"
    echo "      --test_scene ${test_scene}\\"
    echo "      --datadir ./data/inpaint360/${dataset} \\"
    echo "      --N_gt 0 \\"
    echo "      --factor ${factor}"
    echo "----------------------------"
} | tee -a "${LOG_FILE}"
...
python DS_NeRF/run_nerf.py \
    ...
    --N_iters 10001 \
    --i_testset 1000 \
    --expname ${dataset}_2_bash_RTXA6000_screen_weight_gt_156 \
    --train_scene ${train_scene} \
    --test_scene ${test_scene} \
    --datadir ./data/inpaint360/${dataset} \
    --N_gt 0 \
